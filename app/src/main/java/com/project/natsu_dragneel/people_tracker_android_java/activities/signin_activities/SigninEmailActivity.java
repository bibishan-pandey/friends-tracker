...
public class SigninEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signin_email_edittext = (EditText)findViewById(R.id.signin_password_edittext);
        dialog = new ProgressDialog(this);
        auth = FirebaseAuth.getInstance();
        signin_email_next_button = (Button)findViewById(R.id.signin_password_next_button);
